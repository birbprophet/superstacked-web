...
import LogoBackground from "@/components/brand/LogoBackground";
    ...
    <div className="pt-safe">
      <Popover className="relative bg-white max-w-7xl mx-auto">
        <div className="flex justify-between items-center px-4 py-6 sm:px-6 md:justify-start md:space-x-10">
          <div className="flex justify-start lg:w-0 lg:flex-1 bg-gray-500">
            <Link href="/">
              <a className="flex">
                <span className="sr-only">SuperStacked</span>
                <LogoBackground className="h-10 w-10" />
                  ...
                  <div>
                    <Link href="/">
                      <a className="flex items-center">
                        <span className="sr-only">PasteMagic</span>
                        <Image
                          src="/brand/LogoBackground.svg"
                          layout="fill"
                          className="h-8 sm:h-10 w-8 sm:w-10 mr-2 sm:mr-3"
                        />
                        <span className="text-xl sm:text-2xl font-black text-gray-800">
                          PasteMagic
                        </span>
