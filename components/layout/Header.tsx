...
const resources = [
  ...
  },
  {
    name: "Blog",
    description:
      "Follow our blog where we share best practices on automation and more.",
    href: "/blog",
  },
  {
    name: "Contact",
    description: "Need help? Have a question? Drop us a message here.",
    href: "/contact",
  },
  {
    name: "Community",
    description:
      "Join our community and share your feedback on how we can improve.",
    href: "/community",
  },
];
  ...
  return (
    <header className="relative w-full z-20">
      <Popover className="relative max-w-7xl mx-auto">
        <div className="flex justify-between items-center px-6 py-6 sm:px-6 md:justify-start md:space-x-10">
                          ...
                          <div className="relative grid gap-6 bg-gray-850 px-5 py-6 sm:gap-8 sm:p-8 lg:grid-cols-2">
                            {solutions.map((item) => (
                              <a
                                key={item.name}
                                href={item.href}
                                className="-m-3 p-3 flex items-start rounded-lg hover:bg-gray-750"
                              >
              ...
              <div className="py-6 px-5">
                ...
                <div className="mt-6">
                  ...
                  <p className="mt-6 text-center text-base font-medium text-gray-400">
                    ...
                    <Link href="/app/login">
                      <a className="ml-1 text-primary-500 hover:text-primary-400">
                        Login
                      </a>
                    </Link>
                  </p>
